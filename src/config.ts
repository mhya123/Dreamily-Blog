...
export const siteConfig: SiteConfig = {
	...
	favicon: [
		// 留空以使用默认 favicon
		 {
		   src: 'https://q2.qlogo.cn/headimg_dl?dst_uin=1015000721&spec=0',    // 图标文件路径
...
export const fullscreenWallpaperConfig: FullscreenWallpaperConfig = {
	...
	src: {
		desktop: [
			"https://image.fkme.cyou/i/2025/08/23/h3cv0h.webp",
		], // 桌面横幅图片
		mobile: [
			"https://image.fkme.cyou/i/2025/08/30/1njunl.webp",
	...
	links: [
		...
		// 支持自定义导航栏链接,并且支持多级菜单,3.1版本新加
		{
			...
			children: [
				{
					name: "GitHub",
					url: "https://github.com/mhya123",
					external: true,
					icon: "fa6-brands:github",
				},
				{
					name: "Bilibili",
					url: "https://space.bilibili.com/670240796",
					external: true,
					icon: "fa6-brands:bilibili",
				},
				{
					name: "X",
					url: "https://x.com/mhya520",
					external: true,
					icon: "mdi:twitter",
				},
				{
					name: "Youtube",
					url: "https://www.youtube.com/@Aparamecium",
					external: true,
...
export const profileConfig: ProfileConfig = {
	avatar: "https://q2.qlogo.cn/headimg_dl?dst_uin=1015000721&spec=0", // 相对于 /src 目录。如果以 '/' 开头，则相对于 /public 目录
	name: "MhYa123",
	bio: "用永远相信美好的事物即将发生！",
	links: [
		{
	...
	umami: {
		...
		shareId: "gvB5BXBRDRIvbx2J", //填入共享URL最后面那一串  比如：https://eu.umami.is/api/share/2dKQ5T0WrUn6AYtr 你就填入2dKQ5T0WrUn6AYtr
